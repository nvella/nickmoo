...
MObject.prototype.init = function(options, callback) {
  ...
  doc._inherit = options.inherit || this._app.rootId; // Set this object's inheritance parent to the root ID or inherit if provided
  doc._owner   = options.owner || this._app.rootId; // Set this object's owner to root
