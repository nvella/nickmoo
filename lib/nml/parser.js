      ...
      default:
        ...
        switch(line[i]) {
          ...
          case ']': // Close array/list
            if(ctxStack.slice(-1)[0].type !== 'array') throw 'last opened context in line was not an array';
...
Parser.codeToAst = function(code) {
  ...
  for(var lineNo in lines) {
    ...
    // Step 2- This is a statement of some kind. Figure out what it is and put it
