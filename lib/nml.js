...
// Loads a block of written NML code and translates it to the AST
NML.prototype.loadStr = function(code) {
  var lines = code.split("\n");
  var blockStack = [this.ast]; // Code is added to the last element on this
                               // array/stack.
  ...
  for(var lineNo in lines) {
    ...
    var initialKeyword = line.split(' ')[0];
